...
class PMerger2to1(ComplexObjectBase):
    ...
    def create_elements(self, sk):
        self.add_JJ(name='J1', A=1, B=0, al=1, loc=[sk[0], 0])
        self.add_JJ(name='J2', A=1, B=0, al=1, loc=[sk[1], 0])
        self.add_JJ(name='J3', A=0.7, B=0, al=1, loc=[sk[0], sk[2]])
        self.add_JJ(name='J4', A=0.7, B=0, al=1, loc=[sk[1], sk[2]])
        self.add_JJ(name='J5', A=1, B=0, al=1, loc=[sk[2], 0])

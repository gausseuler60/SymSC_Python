...
class Inverter(ComplexObjectBase):
    ...
    def create_elements(self, sk):
        self.add_ib(name='Io1', val=2.01, loc=[sk[6]])
        self.add_ib(name='Io2', val=1.92, loc=[sk[12]])
        ...
        self.add_L(name='L3', val=0.392, loc=[sk[3], sk[5]])
        self.add_L(name='L4', val=0.133, loc=[sk[6], sk[5]])
        self.add_L(name='L5', val=0.371, loc=[sk[5], sk[7]])
        self.add_L(name='L6', val=0.033, loc=[sk[8], 0])
        self.add_L(name='L7', val=0.369, loc=[sk[9], sk[10]])
        self.add_L(name='L8', val=0.124, loc=[sk[10], sk[11]])
        self.add_L(name='L9', val=0.396, loc=[sk[18], sk[20]])
        self.add_L(name='L10', val=0.271, loc=[sk[12], sk[11]])
        self.add_L(name='L11', val=2.23, loc=[sk[13], sk[11]])
        self.add_L(name='L12', val=0.215, loc=[sk[19], sk[20]])
        self.add_L(name='L13', val=0.492, loc=[sk[14], sk[13]])
        self.add_L(name='L14', val=0.127, loc=[sk[15], sk[14]])
        self.add_L(name='L15', val=0.386, loc=[sk[16], sk[14]])
        self.add_L(name='L16', val=0.008, loc=[sk[17], 0])
        self.add_L(name='L17', val=0.3, loc=[sk[1], sk[16]])
        self.add_L(name='L18', val=0.332, loc=[sk[20], sk[21]])

...
class MReceiver(ElementBase):
    ...
    def unzip(self):
        ...
        add_JJ(name='Jin', A=0.96, B=0, al=1, data_index=[sk[2], 0])
        add_JJ(name='J1', A=1.12, B=0, al=1, data_index=[sk[6], 0])
        add_JJ(name='Jout', A=2.01, B=0, al=1, data_index=[sk[8], 0])

        add_L(name='Lin', val=0.95, data_index=[sk[0], sk[10]])
        add_L(name='L1', val=0.05, data_index=[sk[10], sk[2]])
        add_L(name='L2', val=1.76, data_index=[sk[10], sk[3]])
        ...
        add_L(name='Lout', val=0.75, data_index=[sk[7], sk[1]])

...
class NDRO(ComplexObjectBase):
    ...
    def create_elements(self, sk):
        ...
        self.add_JJ(name='J1', c=1, r=1, A=1, B=0, loc=[sk[7], 0])
        self.add_JJ(name='J2', c=1, r=1, A=1.5, B=0, loc=[sk[8], sk[11]])
        self.add_JJ(name='J3', c=1, r=1, A=2, B=0, loc=[sk[9], 0])
        self.add_JJ(name='J4', c=1, r=1, A=1.5, B=0, loc=[sk[11], 0])
        self.add_JJ(name='J5', c=1, r=1, A=1.5, B=0, loc=[sk[5], sk[8]])
        self.add_JJ(name='J6', c=1, r=1, A=1, B=0, loc=[sk[10], sk[11]])
        self.add_JJ(name='J7', c=1, r=1, A=1, B=0, loc=[sk[6], sk[7]])
